...
public class MulticastProtocolPerfTests
{
    ...
    {
        testGroup(new TestLoadSpec(SizeType.SMALL, 0, SizeType.SMALL, 0, SendFrequencyType.MAXIMUM, 0d, 
            SendType.DIRECT, SendSourceType.ALL_NODES), Arrays.asList(new TestFailureSpec(FailureTarget.RANDOM_NODE, 
        ...
        testGroup(new TestLoadSpec(SizeType.LARGE, 0, SizeType.LARGE, 0, SendFrequencyType.MAXIMUM, 0d, 
            SendType.DIRECT, SendSourceType.ALL_NODES), Arrays.asList(new TestFailureSpec(FailureTarget.COORDINATOR, 
