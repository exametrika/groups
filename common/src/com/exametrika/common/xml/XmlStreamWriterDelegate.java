...
/**
 * The {@link XmlStreamWriterDelegate} is a simple delegate for {@link XMLStreamWriter}.
 * 
 * @threadsafety This class and its methods are not thread safe.
 * @author Medvedev-A
 */
public abstract class XmlStreamWriterDelegate implements XMLStreamWriter
{
    protected final XMLStreamWriter out;

    protected XmlStreamWriterDelegate(XMLStreamWriter out)
    {
        Assert.notNull(out);
