...
/**
 * The {@link AbstractElementLoader} is an abstract implementation of {@link IElementLoader}.
 * 
...
public abstract class AbstractElementLoader implements IElementLoader
{
    ...
    @Override
    public abstract void loadElement(JsonObject element, ILoadContext context);
