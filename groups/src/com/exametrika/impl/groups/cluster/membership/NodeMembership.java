...
import com.exametrika.api.groups.cluster.INodeMembership;
...
/**
 * The {@link NodeMembership} is implementation of {@link INodeMembership}.
 * 
 * @threadsafety This class and its methods are thread safe.
 * @author Medvedev-A
 */
public final class NodeMembership implements INodeMembership
{
    private final List<INode> nodes;
    private final Map<UUID, INode> nodesByIdMap;
    private final Map<IAddress, INode> nodesByAddressMap;

    public NodeMembership(List<INode> nodes)
    {
