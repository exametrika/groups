...
public final class FlushStateResponseMessagePart implements IMessagePart
{
    ...
    public FlushStateResponseMessagePart(FlushParticipantProtocol.Phase phase, IGroupMembership preparedMembership, 
        IGroupMembershipDelta preparedMembershipDelta, boolean flushProcessingRequired, Set<UUID> failedMembers,
