    ...
    IFailureDetectionListener
{
    ...
    private IGroupMembership installingMembership;
    private IGroupMembershipDelta installingMembershipDelta;
    ...
    public FlushCoordinatorProtocol(String channelName, IMessageFactory messageFactory, IGroupMembershipManager membershipManager,
        IGroupFailureDetector failureDetector, long flushTimeout, FlushParticipantProtocol participantProtocol)
    {
    ...
    public void install(IGroupMembership membership, IGroupMembershipDelta membershipDelta)
    {
        ...
        IGroupMembership currentMembership = membershipManager.getMembership();
    ...
    public void register(ISerializationRegistry registry)
    {
        ...
        registry.register(new GroupMembershipSerializationRegistrar());
    ...
    public void unregister(ISerializationRegistry registry)
    {
        ...
        registry.unregister(new GroupMembershipSerializationRegistrar());
    ...
    private void proceedWithFlushStateResponses()
    {
        ...
        IGroupMembership installingMembership = null;
        IGroupMembershipDelta installingMembershipDelta = null;
        ...
        else
        {
            if (membershipManager.getMembership() != null)
            {
                ...
                if (installingMembership == null)
                    installingMembership = GroupMemberships.createMembership(membershipManager.getMembership(), 
