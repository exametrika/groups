...
/**
 * The {@link CoreFailureDetectionProtocol} represents a core node part of cluster failure detection protocol.
 * 
 * @threadsafety This class and its methods are not thread safe.
 * @author Medvedev-A
 */
public final class CoreFailureDetectionProtocol extends AbstractProtocol implements IClusterMembershipListener, IFailureObserver
{
    ...
    public CoreFailureDetectionProtocol(String channelName, IMessageFactory messageFactory, IMembershipService membershipService,
        IFailureDetector failureDetector, Set<IFailureDetectionListener> failureDetectionListeners, long failureUpdatePeriod)
    {
    ...
    {
        IDomainMembership domainMembership = event.getNewMembership().findDomain(Memberships.CORE_DOMAIN);
