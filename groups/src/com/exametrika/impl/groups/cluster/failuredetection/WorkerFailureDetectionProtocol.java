...
import com.exametrika.impl.groups.cluster.membership.NodeMembershipChange;
import com.exametrika.impl.groups.core.channel.IChannelReconnector;

/**
 * The {@link WorkerFailureDetectionProtocol} represents a worker node part of cluster failure detection protocol.
 * 
 * @threadsafety This class and its methods are not thread safe.
 * @author Medvedev-A
 */
public final class WorkerFailureDetectionProtocol extends AbstractProtocol implements IClusterMembershipListener,
    IFailureObserver, IWorkerControllerObserver
{
    ...
    public WorkerFailureDetectionProtocol(String channelName, IMessageFactory messageFactory, 
    ...
    public void onMembershipChanged(ClusterMembershipEvent event)
    {
        ...
        NodeMembershipChange change = domain.getChange(NodeMembershipChange.class);
