...
/**
 * The {@link GroupDataExchangeProtocol} represents a data exchange protocol based on token circulating in group.
 * 
 * @threadsafety This class and its methods are not thread safe.
 * @author Medvedev-A
 */
public final class GroupDataExchangeProtocol extends AbstractProtocol implements IGroupMembershipListener, IFailureDetectionListener
{
    ...
    public GroupDataExchangeProtocol(String channelName, IMessageFactory messageFactory, IGroupMembershipManager membershipManager, 
        IGroupFailureDetector failureDetector, List<IDataExchangeProvider> dataExchangeProviders, long dataExchangePeriod)
    {
    ...
    protected void doReceive(IReceiver receiver, IMessage message)
    {
        if (message.getPart() instanceof DataExchangeMessagePart)
        {
            ...
            IGroupMembership preparedMembership = membershipManager.getPreparedMembership();
