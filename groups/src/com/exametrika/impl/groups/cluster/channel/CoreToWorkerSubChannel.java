...
/**
 * The {@link CoreToWorkerSubChannel} is a core to worker node sub-channel.
 * 
 * @threadsafety This class and its methods are thread safe.
 * @author medvedev
 */
public class CoreToWorkerSubChannel extends SubChannel implements IChannel
{
    public CoreToWorkerSubChannel(String channelName, LiveNodeManager liveNodeManager, ChannelObserver channelObserver, 
