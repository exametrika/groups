...
import com.exametrika.impl.groups.simulator.agent.SimInterceptorProtocol;
import com.exametrika.spi.groups.cluster.channel.IChannelReconnector;

/**
 * The {@link SimGroupChannelFactory} is a test group channel factory.
 * 
 * @threadsafety This class and its methods are thread safe.
 * @author medvedev
 */
public class SimGroupChannelFactory extends ChannelFactory
{
    ...
    private SimGroupParameters nodeParameters;
    ...
    public SimGroupChannelFactory(SimExecutor executor)
    {
        this(executor, new SimGroupFactoryParameters());
    }
    
    public SimGroupChannelFactory(SimExecutor executor, SimGroupFactoryParameters factoryParameters)
    {
    ...
    public SimGroupChannel createChannel(SimGroupParameters parameters)
    {
        return (SimGroupChannel)super.createChannel(parameters);
    }
    ...
    {
        nodeParameters = (SimGroupParameters)parameters;
        ...
        SimGroupFactoryParameters nodeFactoryParameters = (SimGroupFactoryParameters)factoryParameters;
    ...
    {
        return new SimGroupChannel(channelName, liveNodeManager, channelObserver, protocolStack, transport, messageFactory, 
