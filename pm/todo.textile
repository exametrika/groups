* FlushProtocolTests: testChangeMembershipCoordinatorFailureOnFlush
* Доделать StateTransfer Тесты
  - testServerFailureBeforeFlush, testServerFailureAfterFlush
  - testCoordinatorFailureAfterFlush
  - testGroupFailureBeforeFlush, testGroupFailureAfterFlush
  - testSaveStateInExternalStore
  - сделать тесты эмулирующие различные сбои при работе с состояние (reject, fail при загрузке/выгрузке и др.)
