...
public class Test
{
    public static void main(String[] args) throws Throwable
    {
        List<IShellCommand> commands = new ShellCommandBuilder()
            .name("l1:l2").description("L2 description").namespace().addCommand()
            .name("l1:l2:command1").description("Command1 description")
                .addNamedParameter("p1", Arrays.asList("-p1", "--p1-long"), "-p1, --p1-long", 
                    "P1 description", false)
                .addPositionalParameter("p2", "<p2>", "P2 description", null, null, null)
                .defaultParameter("p3", "<p3>", "P3description", true, true, null, null, null, null).executor(new TestShellCommand()).addCommand()
            .build();
