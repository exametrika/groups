...
-applymapping <build.dir>/exametrika.boot.map
-printmapping <build.dir>/exametrika.boot-out.map
...
-repackageclasses 'com.exametrika.exa.boot'
...
-injars exaa.jar
-injars com.exametrika.boot.jar
